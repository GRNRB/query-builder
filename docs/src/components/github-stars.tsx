...
// A GitHub link that shows the live star count. The site is statically exported, so the
// count is fetched client-side from the public GitHub API on mount; until it resolves (or if
// the request fails / is rate-limited) the link renders without a number.
